...
残りの設定は、デフォルトが含まれているさまざまなURLです。 CASサーバーを指すようにデフォルト値の*localhost*を変更します。 完了したら、* [Save]*をクリックします。 この後、ユーザーが*[Sign In]*リンクをクリックすると、Liferay DXPにサインインするようにCASサーバーに誘導されます。
